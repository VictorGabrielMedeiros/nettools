...
const toolGroups = [
  {
    title: 'Redes & IP',
    description: 'Ferramentas essenciais para cálculo e análise de IPs e redes.',
    items: [
  ...
  {
    title: 'Segurança & DNS',
    description: 'Investigação de domínios, análise de vulnerabilidades e segurança.',
    items: [
  ...
  },
  {
    ...
    description: 'Codificação, geração de senhas, hashes e validações.',
    items: [
  ...
  {
    title: 'Dev & Sysadmin',
    description: 'Ferramentas de produtividade para desenvolvedores e sysadmins.',
    items: [
